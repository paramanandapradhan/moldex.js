 ...
 */
function isCacheValid(cachedData: CachedCurrencyData): boolean {
...
export async function getCurrencyRates(
    ...
    try {
        ...
        const currencyData: CachedCurrencyData = {
 ...
 */
export function clearCurrencyCache(baseCurrency?: string): void {
    if (baseCurrency) {
 ...
 */
export function getCachedCurrencyRates(baseCurrency: string): CurrencyData | null {
