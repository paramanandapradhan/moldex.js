 ...
 * downloadFile(myFile);
 */
export function downloadFile(data: string | URL | File | Blob, filename?: string, mimeType?: string): void {
    ...
    if (typeof data === 'string') {
        ...
        downloadBlob(data, filename || (data as File).name || 'download');
    } else {
 ...
 */
export function downloadStringData(data: string, filename: string, mimeType: string): void {
 ...
 */
export function downloadDataUrl(dataUrl: string, filename: string, mimeType?: string): void {
