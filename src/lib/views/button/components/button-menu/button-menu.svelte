<script lang="ts">
	...
	import {
		...
		mdiChevronDown
	} from '$lib/views/icon/services/icon-path-service.js';
	import type { Snippet } from 'svelte';
	import type { ListItemType } from '$lib/views/button/components/button-list-item/button-list-item.svelte';
	import ButtonListItem from '$lib/views/button/components/button-list-item/button-list-item.svelte';
